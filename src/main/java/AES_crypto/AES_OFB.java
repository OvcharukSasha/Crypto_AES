...
public class AES_OFB { //Output Feedback
    ...
    public String encrypt(String filename, String KeyString, int[][] ivMatrix) throws IOException {
        ...
        while (isFileReadable) {
            ...
            inputRoundIV = ut.deepCopy(aesCipher.DoEncryption(inputRoundIV, keysHexMatrix));

            int[][] cryptedText = matrixXOR(inputRoundIV, hexInputMatrix).clone();
    ...
    public String decrypt(String filename, String KeyString, int[][] ivMatrix) throws IOException {
        ...
        while (isFileReadable) {
            ...
            int[][] plaintTextMatrix = matrixXOR(inputRoundIV, hexInputMatrix).clone();
